...
Загрузчик видео и аудио с **YouTube**, **TikTok** и **Instagram** с веб-интерфейсом и Telegram ботом. Полностью работает в Docker.

### Возможности

- **Мультиплатформенность** — поддержка YouTube, TikTok и Instagram
...
- **История загрузок** — последние загрузки хранятся в localStorage с возможностью повторного скачивания
- **Telegram Бот** — отправьте ссылку на YouTube, TikTok или Instagram, получите видео в ответ (лучшее качество до 50 МБ, идеально для Shorts). Ссылка на бота отображается прямо в Web UI, если он подключён
...
1. Отправьте любую ссылку на YouTube, TikTok или Instagram боту
...
> Когда бот подключён, в нижней части Web UI появляется ссылка на Telegram бота для быстрого доступа.
